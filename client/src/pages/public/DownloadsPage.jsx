            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              {items.map(item => (
                ...
                >
                  ...
                  <a href={`${SERVER_URL}/api/downloads/download/${item._id}`} className="btn" style={{ flexShrink: 0, padding: '0.75rem 1.5rem', background: 'linear-gradient(135deg, var(--primary), var(--accent))', color: 'white', border: 'none', borderRadius: 'var(--radius-md)', fontWeight: 600, boxShadow: '0 8px 20px rgba(79,70,229,0.25)' }}>
