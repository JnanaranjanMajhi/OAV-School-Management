  ...
  return (
    <>
      <div className="section-header" style={{ marginBottom: '2.5rem' }}>
        ...
        <p style={{ color: 'var(--text-muted)', marginTop: '0.5rem', fontSize: '1.05rem' }}>Official communications and documents from the school.</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="empty-state card-elevated" style={{ padding: '4rem 2rem', border: 'none', background: 'var(--bg-card)' }}>
          ...
          <p style={{ color: 'var(--text-muted)' }}>There are no active notices for students at the moment.</p>
        </div>
      ) : (
          ...
          {notices.map((notice) => (
            ...
            >
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: 'auto', paddingTop: '1.25rem', borderTop: '1px dashed var(--border)' }}>
                ...
                {notice.file ? (
                  <a
                    href={notice.file.startsWith('http') ? notice.file : `${SERVER_URL}/${notice.file}`}
                    target="_blank"
