...
export default function AdminGallery() {
  ...
  return (
    <>
      <div style={{ marginBottom: '1.5rem', background: 'linear-gradient(135deg, rgba(236,72,153,0.08), rgba(139,92,246,0.08))', padding: '1.25rem 1.5rem', borderRadius: 'var(--radius-lg)', border: '1px solid rgba(236,72,153,0.1)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
